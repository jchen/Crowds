...
open class Annotation: NSObject, MKAnnotation {
    ...
    @objc public dynamic var coordinate = CLLocationCoordinate2D(latitude: 37.779379, longitude: -122.418433)

    // Required if you set the annotation view's `canShowCallout` property to `true`
    public var title: String? = NSLocalizedString(["none", "low", "slight", "moderate", "high"].randomElement()!, comment: "SF annotation")
